...
export const DEPTH_PROFILES: Readonly<Record<DepthPreset, DepthProfile>> = {
  shallow: {
    ...
    searchResultsPerQuery: 8, maxQueriesPerWorker: 4, maxPagesPerDomain: 3, maxLinksToEvaluate: 30,
    maxLinksToFollow: 3, maxOutlinksPerPage: 30, candidatePoolMultiplier: 3, workerConcurrency: 3,
    maxDecompositionWorkers: 6, maxGapFillQueries: 5, ddgRateLimitMs: 2_200, minRelevanceScore: 0.15,
    synthesisMaxSources: 20, synthesisSourceChars: 600, synthesisMaxTokens: 3_000, contradictionMaxSources: 15,
  ...
  standard: {
    ...
    searchResultsPerQuery: 10, maxQueriesPerWorker: 5, maxPagesPerDomain: 4, maxLinksToEvaluate: 50,
    maxLinksToFollow: 6, maxOutlinksPerPage: 40, candidatePoolMultiplier: 3, workerConcurrency: 3,
    maxDecompositionWorkers: 8, maxGapFillQueries: 6, ddgRateLimitMs: 2_000, minRelevanceScore: 0.13,
    synthesisMaxSources: 30, synthesisSourceChars: 600, synthesisMaxTokens: 4_000, contradictionMaxSources: 20,
    stagnationThreshold: 1, searchPages: 1, searchLanes: 2, workerFanOut: 1,
    extraEngines: ["brave", "mojeek", "searxng", "yandex"], linkCrawlDepth: 1, queryMutationThreshold: 2,
  },
  deep: {
    depthRounds: 5, pageBudgetPerWorker: 12, pageBudgetPerGapWorker: 10, defaultContentLimit: 8_000,
    searchResultsPerQuery: 15, maxQueriesPerWorker: 7, maxPagesPerDomain: 5, maxLinksToEvaluate: 60,
    maxLinksToFollow: 10, maxOutlinksPerPage: 60, candidatePoolMultiplier: 4, workerConcurrency: 4,
    maxDecompositionWorkers: 10, maxGapFillQueries: 8, ddgRateLimitMs: 1_800, minRelevanceScore: 0.1,
    synthesisMaxSources: 50, synthesisSourceChars: 500, synthesisMaxTokens: 5_000, contradictionMaxSources: 30,
  ...
  deeper: {
    depthRounds: 10, pageBudgetPerWorker: 18, pageBudgetPerGapWorker: 14, defaultContentLimit: 12_000,
    searchResultsPerQuery: 18, maxQueriesPerWorker: 10, maxPagesPerDomain: 6, maxLinksToEvaluate: 80,
    maxLinksToFollow: 14, maxOutlinksPerPage: 80, candidatePoolMultiplier: 5, workerConcurrency: 5,
    maxDecompositionWorkers: 12, maxGapFillQueries: 10, ddgRateLimitMs: 1_500, minRelevanceScore: 0.08,
    synthesisMaxSources: 70, synthesisSourceChars: 450, synthesisMaxTokens: 6_500, contradictionMaxSources: 40,
    stagnationThreshold: 2, searchPages: 2, searchLanes: 4, workerFanOut: 2,
    extraEngines: ["brave", "mojeek", "scholar", "searxng", "yandex"], linkCrawlDepth: 2, queryMutationThreshold: 3,
  },
  exhaustive: {
    depthRounds: 15, pageBudgetPerWorker: 25, pageBudgetPerGapWorker: 18, defaultContentLimit: 16_000,
    searchResultsPerQuery: 20, maxQueriesPerWorker: 12, maxPagesPerDomain: 8, maxLinksToEvaluate: 120,
    maxLinksToFollow: 18, maxOutlinksPerPage: 100, candidatePoolMultiplier: 6, workerConcurrency: 6,
    maxDecompositionWorkers: 14, maxGapFillQueries: 14, ddgRateLimitMs: 1_200, minRelevanceScore: 0.06,
    synthesisMaxSources: 100, synthesisSourceChars: 400, synthesisMaxTokens: 8_000, contradictionMaxSources: 60,
    stagnationThreshold: 3, searchPages: 3, searchLanes: 5, workerFanOut: 3,
